...
`provider-stackit` is a [Crossplane](https://crossplane.io/) provider that is built by [intive](https://www.intive.com) using [Upjet](https://github.com/crossplane/upjet) codegeneration tools and exposes XRM-conformant managed resources for the [STACKIT](https://www.stackit.de) API.
