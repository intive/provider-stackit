...
func (mg *Alertgroup) GetTerraformResourceType() string {
	return "stackit_observability_alertgroup"
}
...
func (tr *Alertgroup) GetObservation() (map[string]any, error) {
...
func (tr *Alertgroup) SetObservation(obs map[string]any) error {
...
func (tr *Alertgroup) GetParameters() (map[string]any, error) {
...
func (tr *Alertgroup) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Alertgroup
func (tr *Alertgroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Alertgroup
func (tr *Alertgroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
