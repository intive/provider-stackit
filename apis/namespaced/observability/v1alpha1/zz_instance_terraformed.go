...
func (mg *Instance) GetTerraformResourceType() string {
	return "stackit_observability_instance"
}

// GetConnectionDetailsMapping for this Instance
func (tr *Instance) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"alert_config.global.opsgenie_api_key": "alertConfig.global.opsgenieApiKeySecretRef", "alert_config.global.smtp_auth_password": "alertConfig.global.smtpAuthPasswordSecretRef", "alert_config.receivers[*].email_configs[*].auth_password": "alertConfig.receivers[*].emailConfigs[*].authPasswordSecretRef", "alert_config.receivers[*].webhooks_configs[*].url": "alertConfig.receivers[*].webhooksConfigs[*].urlSecretRef", "grafana_initial_admin_password": "status.atProvider.grafanaInitialAdminPassword"}
}
