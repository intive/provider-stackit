...
type CredentialInitParameters struct {
	...
	// (String) A description of the credential.
	// A description of the credential.
	Description *string `json:"description,omitempty" tf:"description,omitempty"`

	// (String) The Observability Instance ID the credential belongs to.
...
type CredentialObservation struct {
	...
	// It is structured as "project_id,instance_id,username".
...
// Credential is the Schema for the Credentials API. Observability credential resource schema. Must have a region specified in the provider configuration.
