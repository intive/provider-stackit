...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/intive/provider-stackit/apis/namespaced/mongodbflex/v1alpha1.Instance
	...
	// Reference to a Instance in mongodbflex to populate instanceId.
	// +kubebuilder:validation:Optional
	InstanceIDRef *v1.NamespacedReference `json:"instanceIdRef,omitempty" tf:"-"`

	// Selector for a Instance in mongodbflex to populate instanceId.
	// +kubebuilder:validation:Optional
	...
	// (Set of String) Database access levels for the user. Some of the possible values are: [read, readWrite, readWriteAnyDatabase]
...
// User is the Schema for the Users API. MongoDB Flex user resource schema. Must have a region specified in the provider configuration.
