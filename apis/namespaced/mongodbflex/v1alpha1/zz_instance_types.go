...
type InstanceInitParameters struct {
	...
	// (List of String) The Access Control List (ACL) for the MongoDB Flex instance.
	// The Access Control List (ACL) for the MongoDB Flex instance.
	ACL []*string `json:"acl,omitempty" tf:"acl,omitempty"`

	// (String) The backup schedule. Should follow the cron scheduling system format (e.g. "0 0 * * *").
...
type InstanceObservation struct {
	...
	// (String) ID of the MongoDB Flex instance.
...
type OptionsInitParameters struct {
	...
	// (Number) The number of days that daily backups will be retained.
	// The number of days that daily backups will be retained.
	DailySnapshotRetentionDays *float64 `json:"dailySnapshotRetentionDays,omitempty" tf:"daily_snapshot_retention_days,omitempty"`

	// (Number) The number of months that monthly backups will be retained.
	// The number of months that monthly backups will be retained.
	MonthlySnapshotRetentionMonths *float64 `json:"monthlySnapshotRetentionMonths,omitempty" tf:"monthly_snapshot_retention_months,omitempty"`

	// in-time recovery feature will be able to recover.
	...
	// (Number) The number of days that continuous backups (controlled via the backup_schedule) will be retained.
	...
	// (String) Type of the MongoDB Flex instance. Possible values are: Replica, Sharded, Single.
	...
	WeeklySnapshotRetentionWeeks *float64 `json:"weeklySnapshotRetentionWeeks,omitempty" tf:"weekly_snapshot_retention_weeks,omitempty"`
}
...
type OptionsParameters struct {
	...
	// The number of hours back in time the point-in-time recovery feature will be able to recover.
	// +kubebuilder:validation:Optional
	PointInTimeWindowHours *float64 `json:"pointInTimeWindowHours" tf:"point_in_time_window_hours,omitempty"`
...
// Instance is the Schema for the Instances API. MongoDB Flex instance resource schema. Must have a region specified in the provider configuration.
