...
func (mg *Kubeconfig) GetTerraformResourceType() string {
	return "stackit_edgecloud_kubeconfig"
}
...
func (tr *Kubeconfig) GetObservation() (map[string]any, error) {
...
func (tr *Kubeconfig) SetObservation(obs map[string]any) error {
...
func (tr *Kubeconfig) GetParameters() (map[string]any, error) {
...
func (tr *Kubeconfig) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Kubeconfig
func (tr *Kubeconfig) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Kubeconfig
func (tr *Kubeconfig) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
