...
// ResolveReferences of this OrganizationManager.
func (mg *OrganizationManager) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		Extract:      resource.ExtractParamPath("org_id", true),
