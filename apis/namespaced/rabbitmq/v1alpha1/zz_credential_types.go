...
type CredentialInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/intive/provider-stackit/apis/namespaced/rabbitmq/v1alpha1.Instance
	...
	// Reference to a Instance in rabbitmq to populate instanceId.
	// +kubebuilder:validation:Optional
	InstanceIDRef *v1.NamespacedReference `json:"instanceIdRef,omitempty" tf:"-"`

	// Selector for a Instance in rabbitmq to populate instanceId.
	// +kubebuilder:validation:Optional
...
// Credential is the Schema for the Credentials API. RabbitMQ credential resource schema. Must have a region specified in the provider configuration.
