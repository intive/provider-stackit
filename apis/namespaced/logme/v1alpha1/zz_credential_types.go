...
type CredentialInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/intive/provider-stackit/apis/namespaced/logme/v1alpha1.Instance
	...
	// Reference to a Instance in logme to populate instanceId.
	// +kubebuilder:validation:Optional
	InstanceIDRef *v1.NamespacedReference `json:"instanceIdRef,omitempty" tf:"-"`

	// Selector for a Instance in logme to populate instanceId.
	// +kubebuilder:validation:Optional
...
// Credential is the Schema for the Credentials API. LogMe credential resource schema. Must have a region specified in the provider configuration.
