...
type InstanceInitParameters struct {
	...
	// (List of String) The Access Control List (ACL) for the SQLServer Flex instance.
...
// Instance is the Schema for the Instances API. SQLServer Flex instance resource schema. Must have a region specified in the provider configuration.
