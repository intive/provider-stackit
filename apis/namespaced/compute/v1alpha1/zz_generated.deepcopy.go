...
func (in *ServerInitParameters) DeepCopyInto(out *ServerInitParameters) {
	*out = *in
	...
	if in.NetworkInterfacesRefs != nil {
		in, out := &in.NetworkInterfacesRefs, &out.NetworkInterfacesRefs
		*out = make([]v1.NamespacedReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.NetworkInterfacesSelector != nil {
		in, out := &in.NetworkInterfacesSelector, &out.NetworkInterfacesSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.ProjectID != nil {
