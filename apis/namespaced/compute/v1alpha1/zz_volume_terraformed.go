...
func (mg *Volume) GetTerraformResourceType() string {
	return "stackit_volume"
}

// GetConnectionDetailsMapping for this Volume
func (tr *Volume) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"encryption_parameters.key_payload_base64": "encryptionParameters.keyPayloadBase64SecretRef", "encryption_parameters.key_payload_base64_wo": "encryptionParameters.keyPayloadBase64WoSecretRef"}
}
