...
type CredentialInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/intive/provider-stackit/apis/namespaced/opensearch/v1alpha1.Instance
	...
	// Reference to a Instance in opensearch to populate instanceId.
	// +kubebuilder:validation:Optional
	InstanceIDRef *v1.NamespacedReference `json:"instanceIdRef,omitempty" tf:"-"`

	// Selector for a Instance in opensearch to populate instanceId.
	// +kubebuilder:validation:Optional
...
// Credential is the Schema for the Credentials API. OpenSearch credential resource schema. Must have a region specified in the provider configuration.
