...
func (mg *Distribution) GetTerraformResourceType() string {
	return "stackit_cdn_distribution"
}

// GetConnectionDetailsMapping for this Distribution
func (tr *Distribution) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"config.backend.credentials.access_key_id": "config.backend.credentials.accessKeyIdSecretRef", "config.backend.credentials.secret_access_key": "config.backend.credentials.secretAccessKeySecretRef"}
}
