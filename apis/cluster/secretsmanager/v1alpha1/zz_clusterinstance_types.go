...
// ClusterInstance is the Schema for the ClusterInstances API. Secrets Manager instance resource schema. Must have a region specified in the provider configuration.
