...
// ClusterInstance is the Schema for the ClusterInstances API. RabbitMQ instance resource schema. Must have a region specified in the provider configuration.
