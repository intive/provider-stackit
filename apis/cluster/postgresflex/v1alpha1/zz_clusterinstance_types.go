...
// ClusterInstance is the Schema for the ClusterInstances API. Postgres Flex instance resource schema. Must have a region specified in the provider configuration.
