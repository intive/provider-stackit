...
func (mg *GroupRule) GetTerraformResourceType() string {
	return "stackit_security_group_rule"
}
...
// GetInitParameters of this GroupRule
func (tr *GroupRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this GroupRule
func (tr *GroupRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
