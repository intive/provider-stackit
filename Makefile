...
PROJECT_NAME ?= provider-stackit
PROJECT_REPO ?= github.com/intive/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 0.83.0
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-stackit_v0.83.0
